...
class PaymentConfig
{
     ...
     * @since 1.0.0
     */
    public function sendOrderIdentification()
    {
        return (bool)$this->orderIdentification;
    }

    /**
     * @param bool $orderIdentification
     *
     * @since 1.0.0
     */
    ...
    public function toArray()
    {
        return [
            ...
            'orderIdentification'  => $this->sendOrderIdentification(),
        ];
    }
}
