...
describe('Unionpay International test', () => {
  ...
  it('should check the unionpay international process', async () => {
    ...
    await choosePaymentMethod(driver, 'p_method_wirecardee_paymentgateway_unionpayinternational', paymentLabel);
