...
class PayolutionInvoicePaymentTest extends MagentoTestCase
{
    public function testPayment()
    {
        ...
        $this->assertInstanceOf(PayolutionInvoiceTransaction::class, $transaction);
        $this->assertSame($transaction, $payment->getTransaction());

        $this->assertInstanceOf(Config::class, $payment->getTransactionConfig('EUR'));
        $this->assertInstanceOf(PayolutionInvoicePaymentConfig::class, $payment->getPaymentConfig());
