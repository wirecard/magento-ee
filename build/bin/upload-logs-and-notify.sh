...
echo "Timestamp : $(date)"
RANDOM_VALUE=$[ ( RANDOM % 30 ) * ( RANDOM % 5 ) + 1 ]
...
export MAGENTO_CURRENT_VERSION=${MAGENTO_VERSION}
export PROJECT_FOLDER="magento-ee-${MAGENTO_CURRENT_VERSION}"
